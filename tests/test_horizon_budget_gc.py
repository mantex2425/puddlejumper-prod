...
EXPECTED_PICKUP_DIST_IDX = 38  # +2: expected_odometer + expected_odometer_status inserted before expected_pickup (§5.5 sentinel, 2026-06-05)  # +1: dsi_v1 inserted before expected_pickup in offer_history INSERT (DSI v1 step 1, 2026-06-02)
