-- 2026-09-15  decision_engine_v3: net_hourly is the default formula (HELD for sign-off).
--
-- Based on 2026-09-14_decision_engine_v3_dsi_wording.sql (live, md5(prosrc) 03573803).
-- One change: COALESCE(settings->>'dsi_formula', 'weighted') -> 'net_hourly'.
-- Must ship WITH a default dsi_threshold for new drivers (auth.py defaults, app
-- UserPreferences default, wizard); without one a defaulted driver fails closed
-- (config:threshold_not_set -> every offer declined).
