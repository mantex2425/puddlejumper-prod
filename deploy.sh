...
gcloud run deploy puddlejumper-api \
  ...
  --set-secrets "DB_PASSWORD=DB_PASSWORD:3,ANTHROPIC_API_KEY=ANTHROPIC_API_KEY:latest,GOOGLE_MAPS_API_KEY=GOOGLE_MAPS_API_KEY:latest,MAPBOX_API_KEY=MAPBOX_API_KEY:latest" \
