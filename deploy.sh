...
gcloud run deploy puddlejumper-api \
  ...
  --set-secrets "DB_PASSWORD=DB_PASSWORD:latest,GOOGLE_MAPS_API_KEY=GOOGLE_MAPS_API_KEY:latest,MAPBOX_API_KEY=MAPBOX_API_KEY:latest,DB_PASSWORD_READONLY=DB_PASSWORD_READONLY:latest" \
